...
#         exit()
#     while True: 
#         tipo_camara,camare = capture_video.read()
#         gris=cv2.cvtColor(camare,cv2.COLOR_BGR2GRAY)
#         cv2.imshow("mostral la camara",gris)
#         print(tipo_camara)
